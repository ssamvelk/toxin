...
var dateBtns = document.querySelectorAll('.date-dropdawn__svg'),
    filterDate = document.querySelector('.date-wrp'),
    RangeFilterDate = document.querySelector('.date__seach-wrp'),
    fff = function(event){
...
filterDate.addEventListener('click', fff )
RangeFilterDate.addEventListener('click', fff )
